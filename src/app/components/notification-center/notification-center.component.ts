...
export class NotificationCenterComponent {
  ...
  cols = [{ field: 'location', header: 'POS', sort: true }, { field: 'devices', header: 'POPs' }, { field: 'orders', header: 'Sale' }, { field: 'network', header: 'Network' }];
  data = [
    ...
    { id: 7, devices: "18", orders: "151", network: "edium", address: { location: "Beijing, China", latlng: [39.9042, 116.4074] } },
